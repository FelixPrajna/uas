      ...
      <section class="best-sellers">
        ...
        <div class="best-seller-cards">
            <div class="best-seller-card">
                <img src="/img/tofu.jpg" alt="Sweet Tofu">
                <h3>Sweet Tofu</h3>
            </div>
            <div class="best-seller-card">
                <img src="/img/set.jpg" alt="Sukiyaki Set">
                <h3>Sukiyaki Set</h3>
            </div>
            <div class="best-seller-card">
                <img src="/img/sukiyaki.jpg" alt="Sukiyaki Udon">
                <h3>Sukiyaki Udon</h3>
            </div>
            <div class="best-seller-card">
                <img src="/img/tamago.jpg" alt="Salmon Tamago Don">
                <h3>Salmon Tamago Don</h3>
            </div>
        </div>
    </section>
